    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='hostel.courses')),
                ('rooms', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hostel.rooms')),
